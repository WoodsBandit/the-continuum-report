...
Usage:
    from continuum_report.lib.paperless_client import PaperlessClient
...
class PaperlessClient:
    ...
    def __init__(
        ...
        self._doctype_cache: Optional[Dict[int, Dict[str, Any]]] = None
    ...
    def _is_dossier(self, doc: Dict[str, Any]) -> bool:
    ...
    def get_all_tags(self, use_cache: bool = True) -> Dict[int, Dict[str, Any]]:
        """
    ...
    def get_all_document_types(self, use_cache: bool = True) -> Dict[int, Dict[str, Any]]:
        """
        ...
        doc_types: Dict[int, Dict[str, Any]] = {}
        page = 1
    ...
    def get_all_correspondents(self) -> Dict[int, Dict[str, Any]]:
