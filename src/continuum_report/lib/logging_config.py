...
def main() -> None:
    """Demo logging when run as a script."""
    ...
    print("  LOG_FORMAT=json python -m continuum_report.lib.logging_config")
    print("  LOG_LEVEL=DEBUG python -m continuum_report.lib.logging_config")
